...
Shared.BranchItem = 'packagedweed'
Shared.WeedItem = 'weedplant_weed'
Shared.PackedWeedItem = 'packagedweed'
...
Shared.ProcessingProps = {
    ...
    {model = "bkr_prop_weed_table_01a",    coords = vector4(1039.61, -3197.69, -38.17, 269.12),},
...
Shared.GrowTime = 1 -- Time in minutes for a plant to grow from 0 to 100
