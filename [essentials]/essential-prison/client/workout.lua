...
RegisterNetEvent("essential-prison:client:DoChinUp", function()
...
exports['qb-target']:AddTargetModel({-1978741854, 2057317573, -232023078}, {
    options = {
        {
            type = "client",
            event = "essential-prison:client:DoYoga",
...
RegisterNetEvent('essential-prison:client:DoYoga', function()
