...
RegisterNetEvent('essential-prison:client:Locker', function()
    if inJail then
...
RegisterNetEvent('essential-prison:client:ForceOpenLocker', function(data)
    ...
    if locker then
        ...
        QBCore.Functions.TriggerCallback('essential-prison:server:DoesStashExist', function(stashExist)
            if stashExist then
                QBCore.Functions.Progressbar('opening_prisonlocker', 'Opening the locker...', 2000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
...
RegisterNetEvent('essential-prison:client:RemoveLockers', function()
...
RegisterNetEvent('essential-prison:client:SpawnLockers', function()
	    ...
	    for k, v in pairs(Config.GabzLockers) do
            ...
            exports['qb-target']:AddBoxZone("lockers"..k, v.coords, 1.5, 1.6, {
                ...
                options = {
                    {
                        type = "client",
                        event = "essential-prison:client:Locker",
                    ...
                    {
                        type = "client",
                        event = "essential-prison:client:ForceOpenLocker",
                        icon = "fas fa-box-open",
