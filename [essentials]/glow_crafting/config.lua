...
Config.Models = {
    base = {`gr_prop_gr_bench_01b`, `prop_tool_bench02_ld`, `prop_tool_bench02`, `prop_toolchest_02`, `prop_toolchest_03`, `prop_toolchest_03_l2`, `prop_toolchest_05`, `prop_toolchest_04`},
}

Config.benchReps = {
    rep = {"base", "electronic"},
    attachmentRep = {"ammo", "attachment"},
