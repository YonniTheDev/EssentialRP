...
local function getThresholdRecipes(craftingRep, weaponreputation, attachmentRep, benchType)
...
RegisterNetEvent("glow_crafting_cl:openCraftingBench", function(craftingBenchData, benchId)
    ...
    if craftingBenchData then
        ...
        local defaultRecipes = getThresholdRecipes(craftingRep, weaponreputation, attachmentRep, benchType)
...
RegisterNetEvent("glow_crafting_cl:increasedRep", function(craftingRep, weaponreputation, attachmentRep, benchType)
    local recipes = getThresholdRecipes(craftingRep, weaponreputation, attachmentRep, benchType)
