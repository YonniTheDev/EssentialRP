...
-- General Settings
Config.OxyRunDebug = false -- Change to true to enable green boxes for testing
Config.MinimumPolice = 0
Config.CallCopsChance = 25 -- %Chance to alert police
Config.RunCost = 750

Config.Core = 'new' -- new/old - 'new' for users that use a core with the NEW Item Events (Introduced roughly on the 26th of August 2022 to qb-core) / 'old' for users before this update.
Config.Inventory = 'qb-inventory' -- (qb-inventory/qb-inventory etc..)(The Name of your Inventory) IF Config.Core is set to 'old' this Config doesn't matter.
...
Config.ForceAnimation = true -- This will check if you have a 'package' item and force an animation.
Config.Item = 'package' -- Don't change this plz
...
Config.Blip = {
    ...
    Location = vector3(-1564.62, -441.77, 36.8), -- Blip location
    Sprite = 480,
    Display = 4,
    Scale = 0.6,
    Colour = 1,
...
Config.OxySupplierColour = 5 -- This is the color or the marking that shows from your location to the location
Config.OxySupplierRoute = true -- true/false to turn of the route markings and only show blips

Config.OxyRouteColour = 5 -- This is the color or the marking that shows from your location to the location
