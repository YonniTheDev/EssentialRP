...
Config.VehicleWhiteList = {
     ['defaultPolice'] = {
          { label = 'Code311cvpi', model = 'Code311cvpi' },
          { label = 'Code314tahoe', model = 'Code314tahoe' },
          { label = 'Code316FPIU', model = 'Code316FPIU' },
          { label = '2016taurusrb', model = '2016taurusrb' },
          { label = 'Code318Charger', model = 'Code318Charger' },
          { label = 'Code320tahoe', model = 'Code320tahoe' },
          { label = '19ranger', model = '19ranger' },
          { label = 'Code321Tahoe', model = 'Code321Tahoe' },
          { label = 'pit08charg', model = 'pit08charg' },
          { label = 'Code321Durango', model = 'Code321Durango'},
          { label = 'dpscvpi', model = 'dpsvcpi'},
