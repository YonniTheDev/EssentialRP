        ...
        while listen do
            if IsControlJustPressed(0, 38) then -- E
                if inChips then
                    ...
                    TriggerServerEvent("essential-shops:server:sellChips")
                else
                    exports["qb-core"]:KeyPressed()
...
-- Events
RegisterNetEvent("essential-shops:client:UpdateShop", function(shop, itemData, amount)
    TriggerServerEvent("essential-shops:server:UpdateShopItems", shop, itemData, amount)
end)

RegisterNetEvent("essential-shops:client:SetShopItems", function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent("essential-shops:client:RestockShopItems", function(shop, amount)
