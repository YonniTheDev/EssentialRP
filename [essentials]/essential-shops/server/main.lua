...
RegisterNetEvent('essential-shops:server:UpdateShopItems', function(shop, itemData, amount)
    ...
    TriggerClientEvent('essential-shops:client:SetShopItems', -1, shop, Config.Locations[shop]["products"])
end)

RegisterNetEvent('essential-shops:server:RestockShopItems', function(shop)
    ...
    TriggerClientEvent('essential-shops:client:RestockShopItems', -1, shop, randAmount)
end)
...
RegisterNetEvent('essential-shops:server:sellChips', function()
    local src = source
