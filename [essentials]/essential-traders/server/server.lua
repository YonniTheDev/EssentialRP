...
RegisterServerEvent('essential-trade:server:tradeItems', function(trade)
    local src = source
    ...
    if Config.UseTokens and trade.tokenValue ~= nil then
        ...
        TriggerEvent('essential-tokens:server:TakeToken', src, trade.tokenValue)
...
QBCore.Commands.Add('cwdebugtrade', 'toggle debug for trade', {}, true, function(source, args)
    ...
    TriggerClientEvent('essential-trade:client:toggleDebug',source, useDebug)
end, 'admin')