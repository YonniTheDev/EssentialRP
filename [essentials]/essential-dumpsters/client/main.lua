        ...
        options = {
            {
                ...
                action = function(ent)
                    QBCore.Functions.TriggerCallback('essential-dumpsters:server:getEntityState', function(wasDived)
...
RegisterNetEvent('essential-dumpsters:client:ResetEntity', function(netId)
