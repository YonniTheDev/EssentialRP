...
Config.JobCenter = {
    ['towing'] = {
        vpn = false,
        label = "Towing (Job)",
        event = "essential-jobtablet:jobcenter:tow",
    ...
    ['taxi'] = {
        vpn = false,
        label = "Taxi (Job)",
        event = "essential-jobtablet:jobcenter:taxi",
        mem = 1,
        count = 0,
        salary = 'low',
        time = {
    ...
    ['postop'] = {
        ...
        event = "essential-jobtablet:jobcenter:postop",
        mem = 4,
        count = 0,
        salary = 'high',
        time = {
    ...
    ['sani'] = {
        ...
        event = "essential-jobtablet:jobcenter:sanitation",
        mem = 4,
        count = 0,
        salary = 'mid',
        time = {
    ...
    ['gasdelivery'] = {
        vpn = false,
        label = "Gas Delivery (Job)",
        event = "essential-jobtablet:jobcenter:gasdelivery",
        mem = 1,
        count = 0,
        salary = 'high',
        time = {
