...
RegisterNetEvent('essential-pursuitmode:client:updateVehicleMode')
AddEventHandler('essential-pursuitmode:client:updateVehicleMode', function()
        ...
        if IsPedInAnyVehicle(ped) then
            if not InPursuitMode then
                ...
                if DoesEntityExist(vehicle) then
                    TriggerEvent('essential-pursuitmode:client:updateVehicleMode')
                    InPursuitMode = true
                end
            end
        else
