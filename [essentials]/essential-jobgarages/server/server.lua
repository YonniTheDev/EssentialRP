...
RegisterNetEvent('essential-jobgarages:server:update_out_vehicles', function(o)
     o.source = source
     if o.type == 'add' then
          out_vehicles:add(o)
     else
...
CreateCallback('essential-jobgarages:server:doesVehicleExist', function(source, cb, plate, current_garage)
...
CreateCallback('essential-jobgarages:server:get_vehicle_log', function(source, cb, data)
...
CreateCallback('essential-jobgarages:server:save_vehicle', function(source, cb, data)
     -- local functions
...
CreateCallback('essential-jobgarages:server:can_we_store_this_vehicle', function(source, cb, data)
     MySQL.Async.fetchScalar('SELECT hash FROM keep_garage WHERE plate = ?', { data.VehicleProperties.plate }, function(state)
          cb(state)
     end)
end)

RegisterNetEvent('essential-jobgarages:server:update_vehicle_name', function(new_name, plate, current_garage)
     local src = source
...
RegisterNetEvent('essential-jobgarages:server:update_vehicle_plate', function(new_plate, plate, current_garage)
...
RegisterNetEvent('essential-jobgarages:server:set_is_customizable', function(state, plate, current_garage)
     local src = source
     local player = QBCore.Functions.GetPlayer(src)
     if not cidWhiteListed(player, current_garage) then
          Notification(src, 'You are not whitelisted', 'error')
...
RegisterNetEvent('essential-jobgarages:server:delete', function(plate, current_garage)
     local src = source
     local player = QBCore.Functions.GetPlayer(src)
     if not cidWhiteListed(player, current_garage) then
          Notification(src, 'You are not whitelisted', 'error')
...
RegisterNetEvent("essential-jobgarages:server:update_state", function(plate, properties)
     local src = source
     local Player = QBCore.Functions.GetPlayer(src)
     if not plate then
          print('no plate! (essential-jobgarages:server:update_state)')
          return
     end
...
QBCore.Commands.Add('saveInsideGarage', 'Save vehicle in shared garage', {}, false, function(source, args)
     local src = source
     -- auth
     TriggerClientEvent('essential-jobgarages:client:get_current_garage', src, 'essential-jobgarages:server:saveInsideGarage')
end, 'user')
...
RegisterNetEvent('essential-jobgarages:server:saveInsideGarage', function(current_garage)
     local src = source
     local function save(_type, _grades, random_plate)
          TriggerClientEvent('essential-jobgarages:client:get_current_garage', src, 'essential-jobgarages:server:saveInsideGarage_after', { _type, _grades, random_plate })
     end
...
RegisterNetEvent('essential-jobgarages:server:saveInsideGarage_after', function(current_garage, data)
     local src = source
     MySQL.Async.fetchAll('SELECT * FROM keep_garage_categories WHERE garage = ?', { current_garage }, function(res)
          TriggerClientEvent('essential-jobgarages:client:newVehicleSetup', src, data[1], data[2], res, data[3])
     end)
end)

--[[ CreateCallback('essential-jobgarages:server:give_keys_to_all_same_job', function(source, cb, PlayerJob)
...
RegisterNetEvent('essential-jobgarages:server:Notification', function(msg, _type)
     local src = source
     Notification(src, msg, _type)
end)

-- category maker
CreateCallback('essential-jobgarages:server:GET:category', function(source, cb, data)
...
CreateCallback('essential-jobgarages:server:POST:create_category', function(source, cb, inputData, currentgarage)
     local Player = QBCore.Functions.GetPlayer(source)
...
CreateCallback('essential-jobgarages:server:GET:player_job_gang', function(source, cb)
     local src = source
     local Player = QBCore.Functions.GetPlayer(src)
     cb({
...
CreateCallback('essential-jobgarages:server:GET:garage_categories', function(source, cb, current_garage)
...
CreateCallback('essential-jobgarages:server:GET:vehicles_on_category', function(source, cb, category_name, current_garage)
     local src = source
     local Player = QBCore.Functions.GetPlayer(src)
...
CreateCallback('essential-jobgarages:server:POST:edit_category', function(source, cb, _type, new_data, current_data, currentgarage)
...
CreateCallback('essential-jobgarages:server:DELETE:category', function(source, cb, category_name, current_garage)
     local src = source
...
CreateCallback('essential-jobgarages:server:UPDATE:vehicle_category', function(source, cb, plate, new_category, current_garage)
     local src = source
