...
function Open_menu()
     Config.menu = 'essential-menu'
     if Config.menu == 'essential-menu' then
          keep_menu:garage_menu()
          return
     end
end

AddEventHandler('essential-jobgarages:menu:open:garage_menu', function(option)
     Open_menu()
end)
...
function keep_menu:garage_menu()
     ...
     exports['essential-menu']:createMenu(Menu)
end

function keep_menu:categories()
     TriggerCallback('essential-jobgarages:server:GET:garage_categories', function(categories)
          local Menu = {
               {
                    header = "Go Back",
                    action = function()
          ...
          if cidWhiteListed(GetCurrentgarage()) then
               Menu[#Menu + 1] = {
                    ...
                    action = function()
                         TriggerCallback('essential-jobgarages:server:GET:player_job_gang', function(metadata)
                              ...
                              local inputData, reason = exports['essential-output']:ShowInput(Input)
                              if reason == 'submit' then
                                   ...
                                   TriggerCallback('essential-jobgarages:server:POST:create_category', function(result)
                                        Wait(50)
                                        keep_menu:categories()
...
function keep_menu:vehicles_inside_category(category)
     TriggerCallback('essential-jobgarages:server:GET:vehicles_on_category', function(vehicles)
          local Menu = {
               {
                    header = "Go Back",
                    action = function()
                    ...
                    Menu[#Menu + 1] = {
                         ...
                         action = function()
                              TriggerCallback('essential-jobgarages:server:GET:player_job_gang', function(metadata)
                                   ...
                                   local inputData, reason = exports['essential-output']:ShowInput(Input)
                                   if reason == 'submit' then
                                        TriggerCallback('essential-jobgarages:server:POST:edit_category', function(result)
                                             Wait(50)
                                             keep_menu:categories()
                              ...
                              TriggerCallback('essential-jobgarages:server:GET:player_job_gang', function(metadata)
                                   ...
                                   if reason == 'submit' then
                                        if inputData.conf == 'Confirm' then
                                             TriggerCallback('essential-jobgarages:server:DELETE:category', function(result)
                                                  Wait(50)
                                                  keep_menu:categories()
                                             end, category.name, GetCurrentgarage())
                                        else
                                             TriggerServerEvent('essential-jobgarages:server:Notification', "Ok, i won't delete it!", 'error')
                                        end
                                   end
                              end)
                         end
...
function keep_menu:vehicle_actions_menu(vehicle, veh_data, category)
     ...
     if is_restricted_by_cid(vehicle) then
          if check_cids(vehicle) == false then
               TriggerServerEvent('essential-jobgarages:server:Notification', 'This vehicle is not allowed for you', 'error')
               keep_menu:vehicles_inside_category(category)
               return
          end
     end
     ...
     if is_restricted_by_grades(vehicle) then
          if check_grades(vehicle) == false then
               TriggerServerEvent('essential-jobgarages:server:Notification', 'This vehicle is not allowed for your rank', 'error')
               keep_menu:vehicles_inside_category(category)
               return
          end
     end
     ...
     if vehicle.state == 0 then
          TriggerServerEvent('essential-jobgarages:server:Notification', 'Vehicle is already out!', 'error')
          keep_menu:vehicles_inside_category(category)
          return
     end

     TriggerCallback('essential-jobgarages:server:doesVehicleExist', function(result, per)
          if result == true then
               TriggerServerEvent('essential-jobgarages:server:Notification', 'Vehicle is already out!', 'error')
               keep_menu:vehicles_inside_category(category)
               return
          ...
          if not currentgarage or not nearspawnpoint then
               TriggerServerEvent('essential-jobgarages:server:Notification', 'Try to find a free spot!', 'error')
               return
          end
          ...
          QBCore.Functions.SpawnVehicle(veh_data.model, function(veh)
               ...
               TriggerServerEvent('essential-jobgarages:server:update_out_vehicles', {
                    type = 'add',
...
function keep_menu:take_out_menu(data, vehicle, veh, per, category)
     ...
     local Menu = {
          ...
          },
          {
               ...
               action = function()
                    ...
                    TriggerCallback('essential-jobgarages:server:give_keys_to_all_same_job', function(receivers)
                         for _, id in pairs(receivers) do
                              TriggerServerEvent('qb-vehiclekeys:server:GiveVehicleKeys', id, vehicle.plate)
                         end
                    end, PlayerJob)
                    TriggerServerEvent('essential-jobgarages:server:update_state', vehicle.plate, {
                         vehicle = veh,
                         fuel = fuel,
                         engine = engine,
                         body = body,
          ...
          Menu[#Menu + 1] = {
               ...
               action = function()
                    ...
                    if reason == 'submit' then
                         ...
                         TriggerServerEvent('essential-jobgarages:server:update_vehicle_name', inputData.vehicle_name, vehicle.plate, GetCurrentgarage())
                         Wait(50)
                         keep_menu:vehicles_inside_category(category)
                    end
               end
          ...
          Menu[#Menu + 1] = {
               ...
               action = function()
                    TriggerCallback('essential-jobgarages:server:GET:garage_categories', function(categories)
                         ...
                         for key, _category in pairs(categories) do
                              if _category.name ~= 'default' then
                                   _Menu[#_Menu + 1] = {
                                        ...
                                        action = function()
                                             TriggerCallback('essential-jobgarages:server:UPDATE:vehicle_category', function(result)
                                                  Wait(50)
                                                  keep_menu:vehicles_inside_category(category)
                         ...
                         exports['essential-menu']:createMenu(_Menu)
                    end, GetCurrentgarage())
               end
          }
          ...
          Menu[#Menu + 1] = {
               ...
               action = function()
                    ...
                    if reason == 'submit' then
                         ...
                         TriggerServerEvent('essential-jobgarages:server:set_is_customizable', inputData.customizability, vehicle.plate, GetCurrentgarage())
                         Wait(50)
                         keep_menu:vehicles_inside_category(category)
                    end
               end
               ...
               action = function()
                    ...
                    if reason == 'submit' then
                         ...
                         if inputData.delete == 'true' then
                              TriggerServerEvent('essential-jobgarages:server:delete', vehicle.plate, GetCurrentgarage())
                              Wait(50)
                              keep_menu:vehicles_inside_category(category)
                         end
                    end
     ...
     local op = exports['essential-menu']:createMenu(Menu)
...
function keep_menu:vehicle_parking_log(data, per)
     ...
     TriggerCallback('essential-jobgarages:server:get_vehicle_log', function(LOGS)
          local icons = {
...
AddEventHandler('essential-jobgarages:client:take_out', function(data)
     data = data[1]
     ...
     TriggerServerEvent('essential-jobgarages:server:update_state', data.plate, data)
end)

AddEventHandler('essential-jobgarages:client:delete_if_exist', function(plate, veh)
...
AddEventHandler('essential-jobgarages:client:keep_put_back_to_garage', function(e)
     ...
     if veh == nil then
          ...
          if CanPlayerUseGarage() and not IsPauseMenuActive() and inGarageStation then
               ...
               if IsPedInAnyVehicle(plyped, false) then
                    TriggerEvent('essential-jobgarages:client:keep_put_back_to_garage')
                    return
               end
               Open_menu()
          end
     ...
     TriggerCallback('essential-jobgarages:server:can_we_store_this_vehicle', function(result)
          if result ~= nil then
               local currentgarage = GetCurrentgarage()
               VehicleProperties.currentgarage = currentgarage
               TriggerServerEvent('essential-jobgarages:server:update_state', VehicleProperties.VehicleProperties.plate, VehicleProperties)
               TriggerEvent('essential-jobgarages:client:delete_if_exist', VehicleProperties.VehicleProperties.plate, veh)
               return
          end
          TriggerServerEvent('essential-jobgarages:server:Notification', "This garage doesn't accept this vehicle!", 'error')
