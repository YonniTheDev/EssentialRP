const Targeting = Vue.createApp({
    data() {
        return {
            ...
            SuccessIcon: 'https://cdn.discordapp.com/attachments/1089675306631188481/1100981784780476457/activeeye.png', // Instead of icon it's using a image source found in HTML
            SuccessColor: "rgb(0,  157, 177)",   
            StandardColor: "white",
            TargetHTML: "",
