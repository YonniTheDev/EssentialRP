        ...
        if dist <= 1 and not Config.Registers[k].robbed then
            if CurrentCops >= Config.MinimumStoreRobberyPolice then
                ...
                if isAdvanced then
                    ...
                    if success then
                        TriggerServerEvent('qb-storerobbery:removeAdvancedLockpick')
                        ...
                        TriggerServerEvent("qb-storerobbery:removeAdvancedLockpick")
                        QBCore.Functions.Notify("You failed better luck next time..", "error")
...
--                                 end
--                         else
--                             QBCore.Functions.Notify("You Failed... Hope you brought a backup", "error")
--                         end
--                     else
--                         QBCore.Functions.Notify("Not Enough Police (".. Config.MinimumStoreRobberyPolice .." Required)", "error")
--                     end
--             else
--                 QBCore.Functions.Notify("Stores are on a global cooldown!", "error")
--             end
--         end
--     end
-- end
    ...
    for safe,_ in pairs(Config.Safes) do
        ...
        if dist < 1.0 then
            ...
            elseif not Config.Safes[safe].robbed then
                TriggerServerEvent('qb-storerobbery:removesafecracker')
                MemoryGame()
            else
