...
Config.RunAmount = math.random(3, 5) -- How many drop-offs the player can make each run.
Config.StartRunPayment = 250 -- How much you pay at the start to start the run

Config.MinCops = 0 -- Minimum required amount of cops
Config.CallCopsChance = 20 -- %Chance to alert police

Config.Requireditem = "10kgoldchain"

-- Config.LaunderChance = 80 -- %Chance to launder money
-- Config.LaunderItem = 'cash_roll'

Config.OxyChance = 100 -- %Chance to remove jewelery
Config.RunItem = "10kgoldchain"

Config.RareLoot = 100 -- %Chance to receive a rare loot item
Config.RareLootItem = 'vpn' -- Rare loot item
