    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                ...
                icon = '<img src="./img/apps/garage_img.png" style="width: 100%;border-radius: 15px">';
            } else if (app.app == "advert"){
                icon = '<img src="./img/apps/Advertisements.png" class="advert-icon" style="width: 100%;border-radius: 15px">';
            } else if (app.app == "calculator"){
                icon = '<img src="./img/apps/calcilator.png" style="width: 100%;border-radius: 15px">';
                ...
                icon = '<img src="./img/apps/jobcenter.png" style="width: 100%;border-radius: 15px">';
            } else if (app.app == "crypto"){
                icon = '<img src="./img/apps/crypto.png" style="width: 85%;margin-top: 7%;">';
            } else if (app.app == "taxi"){
                icon = '<img src="./img/apps/taxiapp.png" style="width: 100%;border-radius: 15px">';
            } else if (app.app == "lsbn"){
                icon = '<img src="./img/apps/lsbn.png" style="width: 85%;margin-top: 7%;">';
            } else if (app.app == "contacts"){
                icon = '<img src="./img/apps/contacts.png" style="width: 100%;border-radius: 15px">';
            }
             else if (app.app == "gopro"){
                icon = '<img src="./img/apps/camera.png" style="width: 100%;border-radius: 15px">';
            }
            else if (app.app == "gallery"){
                icon = '<img src="./img/apps/gallery.png" style="width: 100%;border-radius: 15px">';
            }else if (app.app == "twitter"){
                icon = '<img src="./img/apps/twitter.png" style="width: 100%;border-radius: 15px">';
            }else if (app.app == "ping"){
                icon = '<img src="./img/apps/gps.png" style="width: 100%;border-radius: 15px">';
            }
...
// $(document).on('click', '.phone-home-button-class', function(event){
...
$(document).on('click', '#silent-mode', function(event){
    event.preventDefault();
    $.post('https://qb-phone/phone-silent-button', JSON.stringify({}),function(Data){
        if(Data){
            $(".silent-mode-two").css({"display":"initial"});
            $(".silent-mode-one").css({"display":"none"});
        }else{
            $(".silent-mode-two").css({"display":"none"});
            $(".silent-mode-one").css({"display":"initial"});
        }
    })
});

$(document).on('click', '.phone-home-button', function(event){
    event.preventDefault();
