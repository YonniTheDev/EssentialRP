...
Config.ConsumablesEat = {
    ...
    ["croasant-chocolate"] = math.random(35, 54),
    ["croasant-ovo"] = math.random(35, 54),
    ["muffin-chocolate"] = math.random(35, 54),
    ["cupcake-baunilha"] = math.random(35, 54),
    ["cupcake-morango"] = math.random(35, 54),
    ["panqueca-mel"] = math.random(35, 54),
