...
Config.SpawnAtLastParkinglot = true -- spawn the vehicle at the last parked location if StoreParkinglotAccuratly = true, if set to true, make sure to apply / run patch1.sql, I recommend applying the tracking snippet from the ReadMe to the phone so you can track the vehicle to the exact parking lot
...
Config.Garages = {
    ...
    ['cresten'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(-1888.22, -298.29),
                vector2(-1883.46, -296.48),
                vector2(-1873.92, -305.09),
                vector2(-1876.9, -315.88),
                vector2(-1881.81, -322.22),
                vector2(-1888.06, -332.0),
                vector2(-1887.92, -342.6),
                vector2(-1891.03, -346.53),
                vector2(-1905.98, -334.56),
                vector2(-1896.55, -322.01),
                vector2(-1901.75, -317.68),
                
            },
            ['minZ'] = 48.24,  -- min height of the parking zone
            ['maxZ'] = 52.24,  -- max height of the parking zone
        },
        label = 'Cresten',
        showBlip = true,
        blipcoords = vector3(-1904.85, -298.24, 48.73),
        blipName = 'Public Parking',
        blipNumber = 357,
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-1896.71, -317.8, 48.89, 231.91),
            vector4(-1894.83, -315.18, 48.89, 235.57),
            vector4(-1885.63, -300.7, 48.9, 145.14),
            vector4(-1877.61, -307.65, 48.89, 143.26),
            vector4(-1891.24, -340.82, 48.9, 323.97),
            vector4(-1894.22, -338.23, 48.89, 322.4),
            vector4(-1897.42, -335.83, 48.89, 322.59),
            vector4(-1900.66, -333.43, 48.89, 322.28),
            vector4(-1879.96, -305.71, 48.89, 143.81),
            vector4(-1882.19, -303.51, 48.89, 144.47),
    ...
    --         vector2(1279.9331054688, -3195.9409179688),
    --         vector2(1279.8028564453, -3195.9028320312),
    --         vector2(1273.0716552734, -3196.5109863281),
    --         vector2(1265.4577636719, -3196.9611816406),
    --         vector2(1265.2476806641, -3205.1452636719),
    --         vector2(1265.4442138672, -3217.2504882812),
    --         vector2(1265.4357910156, -3225.3901367188),
    --         vector2(1265.4051513672, -3234.7770996094),
    --         vector2(1265.5356445312, -3240.5727539062),
    --         vector2(1273.7541503906, -3240.689453125),
    --         vector2(1279.9002685547, -3240.515625),
    --         vector2(1281.0795898438, -3240.1892089844),
    --         },
    --         minZ = 5.9009861946106,
    --         maxZ = 20.9060940742493,
    --     },
    --     label = "Trucker Parking",
    --     showBlip = true,
    --     blipcoords = vector3(1271.8193359375, -3216.8625488281, 5.905978679657),
    --     blipName = "Public Parking",
    --     blipNumber = 357,
    ...
    --     debug = false,
    --     ['ParkingSpots'] = {
    --         vector4(1273.8594970703, -3202.2404785156, 5.9032373428345, 86.432586669922),
    --         vector4(1273.5688476563, -3209.6892089844, 5.9010376930237, 85.459434509277),
    --         vector4(1273.63, -3216.07, 5.9, 90.15),
    --         vector4(1273.59, -3223.2, 5.9, 88.88),
    --         vector4(1274.48, -3230.24, 5.9, 90.79),
    --         vector4(1273.61, -3237.59, 5.9, 90.3),
