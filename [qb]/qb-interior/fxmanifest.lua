...
-- Default (included)
data_file 'DLC_ITYP_REQUEST' 'stream/orgqb/starter_shells_k4mb1.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/st4lth/shell.ytyp'
-- Classic
