...
local function CreateApartmentFurnished(spawn)
	...
	RequestModel(`st4lth_motel_shell`)
	while not HasModelLoaded(`st4lth_motel_shell`) do
	    Wait(3)
	end
	local house = CreateObject(`st4lth_motel_shell`, spawn.x, spawn.y, spawn.z, false, false, false)
