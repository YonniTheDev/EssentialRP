...
local fishAnimation = function()
    -- Remove Fishing Bait
    TriggerServerEvent('essential-fishing:server:RemoveBait')
    ...
    exports['ps-ui']:Circle(function(success)
        if success then
            ...
            TriggerServerEvent('essential-fishing:server:ReceiveFish')
        else
...
RegisterNetEvent('essential-fishing:client:FishingRod', function()
