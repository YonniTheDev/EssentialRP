...
Config.JobPedBlipSprite = 616
Config.JobPedBlipSpriteColour = 2
...
Config.Shops = {
    [1] = { -- Do not add a 4th table unless you know what you are doing, its not as simple as just copy and pasting in here
        ...
        Packages = 16, -- If you want a random amount of packages to deliver then replace the number with a math.random(10, 13) 
...
--         },
--         Packages = math.random(5, 9), -- If you want a random amount of packages to deliver then replace the number with a math.random(10, 13) 
--         Payment = math.random(350, 500), --If you want a random payments then replace the number with a math.random(350, 420)
--         Reputation = 10, -- Reputation given after a delivery
--     },
--     [2] = {
--         Coords= { -- These coords are more to the mid part of the map
...
--         },
--         Packages = math.random(12, 15),
--         Payment = math.random(540, 700),
--         Reputation = 10,
--     },
--     [3] = {
--         Coords= { -- These coords are more to the top part of the map
...
--         },
--         Packages = math.random(5, 15),
--         Payment = math.random(900, 1250),
--         Reputation = 10,
--     },
-- }
