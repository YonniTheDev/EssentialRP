        ...
        options = {
            {
                ...
                action = function()
                    TriggerServerEvent('essential-deliveries:CreateDeliveryGroupJob')
                end,
            },
            {
                icon = 'fas fa-circle',
                ...
                action = function()
                    TriggerServerEvent('essential-deliveries:canceldelivery')
                end,
            },
            {
                icon = 'fas fa-circle',
                ...
                action = function()
                    TriggerServerEvent('essential-deliveries:ReturnVehicleAndClean')
                end,
            },
            {
                icon = 'fas fa-circle',
                label = 'Apply for Job',
                action = function()
                    TriggerServerEvent('essential-deliveries:TakeJob')
                end,
            },
            {
                icon = 'fas fa-circle',
                ...
                action = function()
                    TriggerServerEvent('essential-deliveries:checkreputation')
                end,
            },
            -- {
            --     icon = 'fas fa-circle',
...
RegisterNetEvent('essential-deliveries:createjobvehicle', function ()
    ...
    onJob = true
    TriggerServerEvent('essential-deliveries:givegroupvehiclekeys', VehiclePlate, networkID)
end)

RegisterNetEvent('essential-deliveries:addvehicletarget', function (networkID)
    truckBones = {
        'seat_dside_r',
        'seat_pside_r'
    }
            ...
            options = {
                {
                    ...
                    action = function(entity)
                        handPackage =  true
                        TriggerServerEvent('essential-deliveries:TakePackages')
                    end,
...
RegisterNetEvent('essential-deliveries:changevarible', function ()
    handPackage = false
end)

RegisterNetEvent('essential-deliveries:addstoretarget', function (Coords)
    shopCoords = Coords
            ...
            options = {
                {
                    ...
                    action = function()
                        handPackage = false
                        TriggerServerEvent('essential-deliveries:DeliverPackage', deliveryItem)
                    end,
                },
            },
        distance = 1.5
...
RegisterNetEvent('essential-deliveries:RemoveTarget', function ()
    exports['qb-target']:RemoveTargetBone(truckBones, 'Take Package')
end)

RegisterNetEvent('essential-deliveries:canreturn', function ()
    returnVehicle = true
end)

RegisterNetEvent('essential-deliveries:ReturnVehicle', function ()
    returnVehicle = false
    onJob = false
...
RegisterNetEvent('essential-deliveries:deletevehicle', function ()
...
RegisterNetEvent('essential-deliveries:cleareverything', function ()
    truckBones = nil
    onJob = false
    packagesDelivered = false
    hasPackage = false
