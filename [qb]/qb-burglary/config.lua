...
Config.RequiredItem = { "advancedlockpick", "screwdriverset" }

-- If true the item required to speak to the bossman will be removed
Config.RemoveRequiredItem = false
...
Config.JobTime = { 180, 240 } -- [1] = min seconds, [2] = max seconds
...
-- You can set the required level for t1/t2/t3 in houses/tier1.lua/tier2.lua/tier3.lua - https://gyazo.com/ab693e698bd2bfb92a18b350d5acbbd2
Config.MaxLevel = 10
...
Config.Bossman = {
    ...
    [2] = {
        ["model"] = "ig_malc",
        ["location"] = vector4(1401.2391357422, -2305.9904785156, 64.35912322998, 277.62844848633),
        ["scenario"] = "WORLD_HUMAN_DRUG_DEALER",
    }
}
...
Config.Prompts = {
    ...
    ["bossman2"] = "You should probably come back more prepared",
...
Config.ResetCurrentBucket = true
